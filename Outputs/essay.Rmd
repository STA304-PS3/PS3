...
Below is the data set used in this analysis: 
...
After observing the data set, we noticed some immediate trends. One of the most prominent trends was that the data was skewed towards the older population. This is evident below: 
